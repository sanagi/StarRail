...
public class CameraShake : MonoBehaviour
{
    ...
    public void ShakeAddPos()
    {
        shakes.Add(new Shake(0.25f, 1.0f, 2.0f, CameraShakeTarget.Position, CameraShakeAmplitudeCurve.FadeInOut25));
        _isShake = true;
    }
    public void AddShakeRotate()
    {
        shakes.Add(new Shake(15.0f, 1.0f, 2.0f, CameraShakeTarget.Rotation, CameraShakeAmplitudeCurve.FadeInOut25));
        _isShake = true;
    }
